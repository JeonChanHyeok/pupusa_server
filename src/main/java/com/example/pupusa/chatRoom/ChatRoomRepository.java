...
public interface ChatRoomRepository extends JpaRepository<ChatRoom, Long> {
    ...
    List<ChatRoom> findAllByStoreAndIsEnd(Store s, boolean a);
    ...
    @Modifying
    @Transactional
    @Query("UPDATE ChatRoom SET chatRoomAddress=:chatRoomAddress WHERE chatRoomId=:chatRoomId")
    int updateChatRoomAddress(@Param(value="chatRoomAddress")String chatRoomAddress, @Param(value="chatRoomId") Long chatRoomId);
